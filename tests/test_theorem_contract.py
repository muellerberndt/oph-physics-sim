...
def _write_valid_endogenous_clock(run: Path) -> None:
    _write_json(
        run / "bw_state_derived_report.json",
        {
            ...
            "state_mode": "prime_geometric_cap_state",
            "row_count": 4,
            "median": 0.01,
            ...
            "endogenous_modular_generator_receipt": True,
            "PRIME_GEOMETRIC_CAP_STATE_RECEIPT": True,
            "CAP_INTERIOR_MODULAR_HAMILTONIAN_RECEIPT": True,
            "noncommutative_cap_algebra_receipt": True,
            "faithful_cap_state_receipt": True,
            "cap_algebra_scope": (
                "overlap_generated_prime_geometric_noncommutative_cap_interior"
            ),
            "modular_generator_definition": "K_C=-log(rho_C)",
            ...
            "kms_geometric_clock_fit_receipt": True,
            "INDEPENDENT_GEOMETRIC_CLOCK_PARAMETER_RECEIPT": True,
            "inferred_modular_clock_fit": {
                ...
                "KMS_GEOMETRIC_CLOCK_FIT_RECEIPT": True,
                "INDEPENDENT_GEOMETRIC_CLOCK_PARAMETER_RECEIPT": True,
                "geometric_parameter_source": "ordered_bw_frame_source_derived",
                "candidate_scales": ["1x", "pi", "2pi", "4pi"],
                "full_center_minimization_receipt": True,
                "geometry_target_contains_pi": False,
                "cross_ratio_construction_contains_2pi": False,
