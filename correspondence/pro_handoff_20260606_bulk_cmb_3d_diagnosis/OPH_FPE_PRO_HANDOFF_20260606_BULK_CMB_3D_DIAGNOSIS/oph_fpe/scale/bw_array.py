...
def run_bw_array_config(config: dict[str, Any], out_dir: Path) -> dict[str, Any]:
    ...
    emergence_status["OBJECT_BULK_POPULATION_RECEIPT"] = bool(
        emergence_status["observer_chart_bulk_population_receipt"]
        or emergence_status["record_family_h3_bulk_population_candidate"]
    )
    emergence_status["object_bulk_population_receipt"] = bool(
    ...
    emergence_status["bulk_population_source"] = (
        ...
        if emergence_status["observer_chart_bulk_population_receipt"]
        else "record_family_support_profile_h3"
    ...
    emergence_status["spatial_bulk_3d_reconstruction_receipt"] = bool(
        emergence_status["OBJECT_BULK_POPULATION_RECEIPT"]
        and strict_neutral_bulk_receipt
    )
    ...
    emergence_status["bulk_population_claim_boundary"] = (
        "OBJECT_BULK_POPULATION_RECEIPT may be sourced by the stricter observer-chart transition-history "
        "gate or by controlled persistent record-family support profiles that fit the conformal H3 cap "
        "chart better than S2-boundary and shuffled-cap controls. Spatial bulk establishment additionally "
        "requires a neutral reconstruction pass and a usable strict blind observer-feature audit with no "
        "S2/support/radial evidence leakage. It is still not a physical cosmology or particle receipt."
    )
...
def _canonical_receipt_ladder_report(
    *,
    ...
    receipts = {
        ...
        "R3": {
            "receipt_name": CONFORMAL_H3_CHART_RECEIPT,
        ...
        "R6": {
            ...
            "fit_objective": "localized_not_boundary_dominated_objects",
        ...
        "R8": {
            "receipt_name": STATIC_GALAXY_LAW_RECEIPT,
