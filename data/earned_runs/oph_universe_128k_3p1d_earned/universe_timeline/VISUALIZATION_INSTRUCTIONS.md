...
```bash
open runs/oph_universe_128k_3p1d_earned/universe_timeline/oph_universe_timeline_viewer.html
```
...
```bash
runs/oph_universe_128k_3p1d_earned/universe_timeline/visualization_payload.json
```
