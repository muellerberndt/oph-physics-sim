...
TRANSFORMS: tuple[TheoremTransform, ...] = (
    ...
    TheoremTransform(
        ...
        (
            ...
            "PORT_CURRENT_ORDERED_LOOP_COMMUTATOR_RECEIPT",
            "PORT_CURRENT_COMMUTATOR_CLOSED_IN_PORT_TANGENT_RECEIPT",
            "PORT_CURRENT_COMPACT_SKEW_ADJOINT_RECEIPT",
            "A5_OVERLAP_HOLONOMY_FULLNESS_RECEIPT",
            "A5_SAME_SOURCE_INTERNAL_CURRENT_IMPLEMENTER_RECEIPT",
            "PORT_CURRENT_NO_HIDDEN_PUBLIC_TANGENT_RECEIPT",
