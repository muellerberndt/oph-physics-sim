...
def comparable_data_report(run_dirs: list[Path]) -> dict[str, Any]:
    ...
    return {
        ...
        "claim_boundary": (
            ...
            "are solver scaffolds unless their screen-power input is simulator-derived. OPH-CMB anomaly-stress "
...
def _oph_screen_power_summary(rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "interpretation": (
            ...
            "the exported reference table is a phenomenological Planck-target fallback rather than a "
            "simulator-derived primordial prediction."
        ),
    }
...
def _oph_screen_camb_summary(rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "interpretation": (
            ...
            "input screen report is simulator-derived rather than the Planck-target fallback."
        ),
    }
...
def _sync_gap_summary(rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "interpretation": (
            ...
            "and global Phi decay are useful diagnostics, but a true horizon-coherence/gap claim requires "
            "time-resolved harmonic repair traces and controls."
        ),
    }
