...
def write_run_viewer(
    ...
    *,
    ...
    h3_points = _h3_points(record_h3, defect_h3)
...
def _h3_points(record_h3: dict[str, Any], defect_h3: dict[str, Any]) -> list[dict[str, Any]]:
    rows: list[dict[str, Any]] = []
    for label, report, value in [("record", record_h3, 0.35), ("defect", defect_h3, 0.95)]:
        points = report.get("h3_fit", {}).get("sample_fitted_h3_points", []) if report else []
